...
export default function SipTab({ user }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-2xl p-5 shadow-xl shadow-cyan-950/30 text-white relative overflow-hidden flex items-center justify-between">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-extrabold tracking-tight font-amount">{formatINR(totalSipAmount)}</h3>
      ...
      {/* Main Full-Width Active SIPs List */}
      <div className="bg-[#111827] rounded-3xl p-5 sm:p-8 shadow-2xl border border-slate-800/80 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-3 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl font-bold text-sm shadow-xl shadow-cyan-600/20 transition-all active:scale-98 shrink-0"
          >
        ...
        {isLoading ? (
          ...
          <div className="py-20 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-slate-500 mt-1 max-w-sm">Click "+ New SIP Entry" above to start tracking your mutual fund investments.</p>
          </div>
        ) : (
          <div className="max-h-[460px] overflow-y-auto custom-scrollbar pr-2 space-y-4">
            {sips.map((sip) => (
              <div key={sip.id} className="group bg-slate-900/60 hover:bg-slate-900 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between border border-slate-800/80 hover:border-slate-700 transition-all gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-100 text-base">{sip.fundName}</h4>
                    <div className="flex flex-wrap items-center gap-2 mt-2">
                      <span className="text-xs font-semibold px-2.5 py-1 rounded-md bg-slate-800 text-cyan-300 flex items-center gap-1 border border-cyan-500/20">
                ...
                <div className="flex items-center gap-5 justify-between sm:justify-end border-t sm:border-t-0 pt-3 sm:pt-0 border-slate-800">
                  <span className="font-extrabold text-xl text-slate-100 font-amount">{formatINR(sip.amount)}</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-800">
                ...
                <button 
                  type="submit" 
                  disabled={isAdding} 
                  className="flex-1 bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-3.5 rounded-xl shadow-xl shadow-cyan-600/20 flex justify-center text-lg transition-all active:scale-[0.98]"
                >
